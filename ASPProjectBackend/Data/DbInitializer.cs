...
""271590"": {
    ...
    public static async Task<Game> CreateGameObjFromJson(int appId)
    {
        ...
        {
            if (gameData.PriceOverview == null)
            {
                gameData.PriceOverview = new Price();
            }
